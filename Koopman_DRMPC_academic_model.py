...
if __name__ == "__main__":
    ...
    academic_sim = Simulation(ode, delta_t, N, z_init, C, D, E, F, G, F_t, Q, Qf, R, cont_time=False, nonlinear=False,
                          u_0=u_0, xr=zr, ur=ur, collect=False, est=False, mu=mu, sigma=sigma, beta=1,
                          sin_const=sin_const, N_sample=2, epsilon=1, N_sim=N_sim, data_set=None, N_sample_max=None,
